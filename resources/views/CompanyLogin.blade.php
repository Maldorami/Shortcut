...
<script src="js/CompanyLogInValidation.js"></script>
@section('content')
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">{{ __('Página de inicio de sesión para Companies') }}</div>

        <div class="card-body">
          <form id="CompanyLogin" class="forml-horizontal" method="post">
            @csrf
